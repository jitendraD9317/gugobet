        ...
        <Box className='sport_page' marginTop="80px">
            ...
            <Box className='sportTop'>
                <Box className='section_title_wr'>
                    ...
                    <Heading as="h6" className='section_title section_title_White' color={primaryText} >Casino</Heading>
                </Box>
                    ...
                    <div style={{ padding: '0px' }} className="cardsSlider custom-carousel w-[100%] mt-0 relative">
                        <Slider ref={sliderRef} {...settings}>
                            {casinoCardContent.map((item, index) => (
                                <Box key={index} className="w-[100%] relative" style={{ width: '190px' }} >
            ...
            <Box className='roulette sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Roulette</Heading>
                    </Box>
                    <Box display="flex">
                        <Text marginRight="5px" color={allBtn} fontWeight="700">All</Text>
                        <RiPlayFill size={24} color={arrowBg} />
            ...
            <Box className='dragon_tiger sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Dragon Tiger</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
            ...
            <Box className='baccarat sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Baccarat</Heading>
                    </Box>
                    <Box display="flex">
                        <Text marginRight="5px" color={allBtn} fontWeight="700">All</Text>
                        <RiPlayFill size={24} color={arrowBg} />
            ...
            <Box className='blackjack sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Blackjack</Heading>
                    </Box>
                    <Box display="flex">
                        <Text marginRight="5px" color={allBtn} fontWeight="700">All</Text>
                        <RiPlayFill size={24} color={arrowBg} />
            ...
            <Box className='poker_card sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Poker Card</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
