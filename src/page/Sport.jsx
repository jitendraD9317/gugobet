...
// Provider
import providerIcon from '../assets/images/sport/provider/provider.svg';
import wicketicon from '../assets/images/sport/provider/9wicket.png';
import luckysports from '../assets/images/sport/provider/luckysports.png';
import saba from '../assets/images/sport/provider/saba.png';
import IM from '../assets/images/sport/provider/im.png';
import digitain from '../assets/images/sport/provider/digitain.png';
...
const Sport = () => {
    const { sectionBg, gray30, caretColor, borderColor, primaryText, arrowBg, allBtn, logoLIineFooter,
        ...
        scrollBarBg, scrollThumbBg, sportTopDivider,
        ...
        <Box className='sport_page' marginTop="80px">
            ...
            <Box className='sportTop'>
                <Box className='section_title_wr'>
                    ...
                    <Heading as="h6" className='section_title section_title_White' color={primaryText} >Sports</Heading>
                </Box>
                ...
                <Box marginTop="10px">
                    <Flex gap="5px">
                        <Flex className="icon" gap="5px" alignItems="center" justifyContent="center" style={{...providerStyle}}>
                            <Image src={wicketicon} boxSize="19px"></Image>
                            <Text>9wicket</Text>
                        </Flex>
                        <Flex className="icon" gap="5px" alignItems="center" justifyContent="center" style={{...providerStyle}}>
                            <Image src={luckysports} boxSize="19px"></Image>
                            <Text>LuckySports</Text>
                        </Flex>
                        <Flex className="icon" gap="5px" alignItems="center" justifyContent="center" style={{...providerStyle}}>
                            <Image src={saba} boxSize="19px"></Image>
                            <Text>SABA</Text>
                        </Flex>
                        <Flex className="icon" gap="5px" alignItems="center" justifyContent="center" style={{...providerStyle}}>
                            <Image src={IM} boxSize="19px"></Image>
                            <Text>IM</Text>
                        </Flex>
                        <Flex className="icon" gap="5px" alignItems="center" justifyContent="center" style={{...providerStyle}}>
                            <Image src={digitain} boxSize="19px"></Image>
                            <Text>Digitain</Text>
                        </Flex>
                    </Flex>
                </Box>
            ...
            <Box className='cricket sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Cricket</Heading>
                    </Box>
                </Box>
            ...
            <Box className='football sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Football</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='tennis sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Tennis</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='basketball sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Basketball</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
                    ...
                    {basketballCardImg.map((item, index) => (
                                <div key={index} className="w-[100%] relative" style={{ width: '190px' }}>
                                    <Box className='card_wr'>
                                        <Box className="card_content" style={{ ...casinoCardsStyle }} css={{
                                            ':after': {
            ...
            <Box className='badminton sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Badminton</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
                    ...
                    {badmintonCardImg.map((item, index) => (
                                <div key={index} className="w-[100%] relative" style={{ width: '190px' }}>
                                    <Box className='card_wr'>
                                        <Box className="card_content" style={{ ...casinoCardsStyle }} css={{
                                            ':after': {
            ...
            <Box className='baseball sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Baseball</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='darts sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Darts</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='esports sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Esports</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='golf sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Golf</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='pool sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Pool</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='table_tennis sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Table Tennis</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='volleyball sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Volleyball</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
