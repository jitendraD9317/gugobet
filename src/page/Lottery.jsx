        ...
        <Box className='sport_page' marginTop="80px">
            ...
            <Box className='sportTop'>
                <Box className='section_title_wr'>
                    ...
                    <Heading as="h6" className='section_title section_title_White' color={primaryText} >Lottery</Heading>
                </Box>
            ...
            <Box className='matka_lottery sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Matka Lottery</Heading>
                    </Box>
                </Box>
            ...
            <Box className='official sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Official</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
            ...
            <Box className='pick_lottery sectionTop_spacing'>
                <Box className='section_title_wr' display="flex" justifyContent="space-between">
                    <Box className='headPart' display="flex">
                        <Heading as="h6" className='section_title section_title_darkGray'>Pick Lottery</Heading>
                    </Box>
                </Box>
                <Box className='cards' marginTop="10px">
                    <Flex style={{ padding: '0px' }} gap="10px" className="cardsSlider custom-carousel relative" css={{
