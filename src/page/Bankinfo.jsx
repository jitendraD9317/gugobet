...
function BankInfo() {
    const { primaryBg, bonusRecordTabsBg, changePassBg, bankinfoBorder, bankinfoShadow, primaryText } = useSelector((state) => state.theme);
            ...
            <Box position="sticky" top="65px" zIndex="99" bg={primaryBg}>
                <Box height="40px" position="relative">
                    ...
                    <Box css={{
                        ...
                        <Heading as="h5" fontSize={{ base: "18px", md: "20px" }} >Bank Info</Heading>
                    </Box>
                </Box>
            </Box>
            <Box className='main_content' maxWidth={{base: "100%", md: "400px"}} style={{ ...contentWrStyle }} >
                <Box className='bonusRecordTabs' bg={bonusRecordTabsBg} p="27px 25px 40px" borderRadius="10px">
                    <Heading className='titleLine' fontSize="20px" paddingLeft="20px" position="relative" _before={{
                        content: "''",
                        position: "absolute",
                        top: "0",
                        left: "0",
                    ...
                    >Your Bank Info</Heading>
                    <Box className='flexCenter' style={{ ...bankInfo }}
                        _after={{
                            content: "''",
                            position: "absolute",
                            bottom: "0",
